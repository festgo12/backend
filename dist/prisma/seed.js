...
const NOTIFICATION_TEMPLATES = [
    ...
    },
    {
        ...
        emailSubject: 'P2N: New Login to Your Account',
        emailBody: '<p>Your P2N account was just accessed.</p><p><strong>Device:</strong> {{deviceName}}</p><p><strong>Browser:</strong> {{browser}}</p><p><strong>Location:</strong> {{location}}</p><p><strong>Time:</strong> {{time}}</p><p style="color:#666;">If this was you, no action is needed. If not, secure your account immediately.</p>',
        pushTitle: 'Login Detected',
        pushBody: 'New login to your account from {{deviceName}} at {{location}}.',
        inAppTitle: 'Login Detected',
        inAppBody: 'Your account was accessed from {{deviceName}} ({{location}}) at {{time}}.',
    },
    {
        type: 'DEPOSIT_CREDITED',
        name: 'Deposit Credited',
        emailSubject: 'P2N: Deposit Credited',
        emailBody: '<p>Your deposit has been credited.</p><p><strong>Amount:</strong> {{amount}} {{currency}}</p><p><strong>Reference:</strong> {{reference}}</p><p>Thank you for using P2N.</p>',
        pushTitle: 'Deposit Credited',
        pushBody: '{{amount}} {{currency}} has been credited to your wallet.',
        inAppTitle: 'Deposit Credited',
        inAppBody: '{{amount}} {{currency}} has been credited to your wallet.',
    },
    {
        type: 'WITHDRAWAL_REQUESTED',
        name: 'Withdrawal Requested',
        emailSubject: 'P2N: Withdrawal Requested',
        emailBody: '<p>Your withdrawal is being processed.</p><p><strong>Amount:</strong> {{amount}} {{currency}}</p><p><strong>Reference:</strong> {{reference}}</p><p style="color:#666;">Funds will be released once confirmed on the blockchain.</p>',
        pushTitle: 'Withdrawal Processing',
        pushBody: 'Your withdrawal of {{amount}} {{currency}} is being processed.',
        inAppTitle: 'Withdrawal Processing',
        inAppBody: 'Your withdrawal of {{amount}} {{currency}} is being processed.',
    },
    {
        type: 'WITHDRAWAL_COMPLETED',
        name: 'Withdrawal Completed',
        emailSubject: 'P2N: Withdrawal Completed',
        emailBody: '<p>Your withdrawal has been completed.</p><p><strong>Amount:</strong> {{amount}} {{currency}}</p><p><strong>Reference:</strong> {{reference}}</p><p>Thank you for using P2N.</p>',
        pushTitle: 'Withdrawal Completed',
        pushBody: 'Your withdrawal of {{amount}} {{currency}} has been completed.',
        inAppTitle: 'Withdrawal Completed',
        inAppBody: 'Your withdrawal of {{amount}} {{currency}} has been completed.',
    },
    {
        type: 'WITHDRAWAL_FAILED',
        name: 'Withdrawal Failed',
        emailSubject: 'P2N: Withdrawal Failed',
        emailBody: '<p>Your withdrawal could not be completed.</p><p><strong>Amount:</strong> {{amount}} {{currency}}</p><p><strong>Reference:</strong> {{reference}}</p><p style="color:#666;">Funds have been refunded to your wallet. If the issue persists, contact support.</p>',
        pushTitle: 'Withdrawal Failed',
        pushBody: 'Your withdrawal of {{amount}} {{currency}} failed. Funds have been refunded.',
        inAppTitle: 'Withdrawal Failed',
        inAppBody: 'Your withdrawal of {{amount}} {{currency}} failed. Funds have been refunded to your wallet.',
    },
];
